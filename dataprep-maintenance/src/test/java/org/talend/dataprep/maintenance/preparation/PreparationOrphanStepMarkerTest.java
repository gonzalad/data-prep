...
public class PreparationOrphanStepMarkerTest {

    @Test
    public void shouldMarkUnusedSteps() {
        // Given
        OrphanStepMarker marker = new PreparationOrphanStepMarker();
        ...
        // When
        final OrphanStepMarker.Result result = marker.mark(repository, "myMarker-1234");

        // Then
        assertEquals(OrphanStepMarker.Result.COMPLETED, result);
    ...
    public void shouldDisableCleanUpAtStart() {
        ...
        // Then
        assertEquals(OrphanStepMarker.Result.INTERRUPTED, result);
    }
